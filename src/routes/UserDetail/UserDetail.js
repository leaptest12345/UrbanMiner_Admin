                            ...
                            license: {
                                ...
                                scrapRecycling: {
                                    ...
                                    expireDate: userDetails?.license?.scrapRecycling?.expireDate
                                        ? new Date(userDetails?.license?.scrapRecycling?.expireDate)
                                        : ''
                                },
                                federal: {
                                ...
                                await update(starCountRef, {
                                    ...
                                    license: {
                                        ...
                                        scrapRecycling: {
                                            ...
                                            expireDate: values?.license?.scrapRecycling?.expireDate
                                        },
                                        federal: {
                                ...
                                <div className='flex flex-col gap-6'>
                                    ...
                                    <div style={styles.rowView}>
                                        ...
                                        <div style={styles.view}>
                                            ...
                                            <DatePickerWithLabel
                                                label='expireDate'
                                                selectedDate={values.license.business.expireDate}
                                                onChange={(value) => {
                                                    setFieldValue(
                                    ...
                                    <div className='flex flex-col gap-2'>
                                        <h3 className='font-bold text-xl text-black'>3) Address</h3>
                                        <InputWithLabel
