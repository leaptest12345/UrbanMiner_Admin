...
export default function AddAdmin()
{
  ...
  const [id,setId]=useState(null)
   ...
   const [addProduct,setAddProduct]=useState(false)
    ...
    const getUsers=()=>{
      try{
          const refDetail=ref(database,'/USERS')
    ...
    const createAdmin=async()=>{
      try{
       ...
       console.log("account alredy",result)
        ...
        if(user)
        {
          const refDetail=ref(database,`/USERS/${uniqueId}`)
          await set(refDetail,{
            ID:uniqueId,
            email:email,
            role:{
          ...
          const refDetail=ref(database,`/USERS/${result}`)
  ...
  const dangerLabel={
    ...
    />
    <label style={labelStyle} className="form-check-label" htmlFor="flexCheckChecked">
 ...
 <label style={labelStyle} className="form-check-label" htmlFor="flexCheckChecked">  
   ...
   <div className="form-check" style={formCheckStyle}>
    ...
    />
 <label style={labelStyle} className="form-check-label" htmlFor="flexCheckChecked">
        User can give the <label style={dangerLabel}>PERMISSION</label> to the Another user 
    </label>
  </div>
  <div className="form-check" style={formCheckStyle}>
    <input
    ...
    />
    <label style={labelStyle} className="form-check-label" htmlFor="flexCheckChecked">
     User can <lable style={dangerLabel}>VIEW/UPDATE</lable> the TermAndCondition
    </label>
  </div>
   <div className="form-check" style={formCheckStyle}>
    <input
    ...
    />
 <label style={labelStyle} className="form-check-label" htmlFor="flexCheckChecked">  
    User can <label style={dangerLabel}>VIEW/UPDATE </label>the PrivacyPolicy
    </label>
  </div>
  <div className="form-check" style={formCheckStyle}>
    <input
